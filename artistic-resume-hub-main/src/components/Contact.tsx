...
const Contact = ({ language }: ContactProps) => {
  ...
  return (
    <section id="contact" className="section-padding bg-white dark:bg-tech-darkblue">
      <div className="container mx-auto">
        <h2 className="section-title">{text.title}</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-10 text-lg">{text.subtitle}</p>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:marouaneessdiki@gmail.com" 
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">MAROUANE ES-SDIKI</p>
                  </div>
                </div>
              </div>
